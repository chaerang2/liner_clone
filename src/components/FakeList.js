import img1_1 from "./css/img/thumnail.jpg"
import img2_1 from "./css/img/webimg.png"
import img1_2 from "./css/img/thumnail2.jpg"
import img2_2 from "./css/img/webimg2.ico"
import img1_3 from "./css/img/thumnail3.png"
import img2_3 from "./css/img/webimg3.png"
const FakeList = {
  pageList:[
    {
      id:1,
      title:"스타트업은 어떻게 아마존도 카피할 수 없는 혁신을 만드는가? : '언카피어블' | ㅍㅍㅅㅅ",
      liner_HL:"<언카피어블>이라는 제목의 첫 문장이다. 이 문장이 인상적인 것은 '갑자기 우리가 (아마존을)이겼다'는 뜻이기 때문이다. 아마존의 연매출은 500조에 이른다. 자금력을 활용해 방해가 되는 회사는 무참히 밟아버린다. <언카피어블>은 그런 아마존을 이긴 회사의 이야기다",
      thumnail:img1_1,
      webimg:img2_1,
      url:"ppss.kr",
    ...
    {
      id:2,
      title:"누구나 원하는 개발자되기 shiren the creator",
      liner_HL:"주요 역량 항목",
      thumnail:img1_2,
      webimg:img2_2,
      url:"blog.shiren.dev",
    ...
    {
      id:3,
      title:"주니어 개발자의 클린 아키텍처 맛보기 - 우아한형제들 기술 블로그",
      liner_HL:"중복으로 보이는 두 코드의 영역이 각자의 경로로 발전한다면, 즉 서로 다른 속도와 다른 이유로 변경된다면 이 두 코드는 진짜 중복이 아니다",
      thumnail:img1_2,
      webimg:img2_2,
    ...
    {
      id:4,
      title:"CORS는 왜 이렇게 우리를 힘들게 하는걸까? | Evan's Tech Blog",
      liner_HL:"즉, CORS는 브라우저의 구현 스펙에 포함되는 정책이기 때문에, 브라우저를 통하지 않고 서버 간 통신을 할 때는 이 정책이 적용되지 않는다",
      thumnail:img1_3,
      webimg:img2_3,
    ...
    {
      id:5,
      title:"wkf 녹인 UX Writing, 열 구구절절 안 부럽다.",
      liner_HL:"우선 원 시안은 배너 형태로, 뱅크샐러드의 기존 일러스트 배경의 디자인이었다. 웹 서비스를 소개하고 홈페이지로 유도하는 구간이라, 그래프가 담긴 노트북 사진으로 pc버전의 장점과 특징을 직관적으로 표현해 보았다",
      thumnail:img1_3,
      webimg:img2_3,
      url:"brunch.co.kr",
